...
def update_homepage(manifests):
    ...
    if manifests:
        ...
        # The Writing list carries hand-kept rows above the markers, so an empty
        # musings block contributes nothing rather than asserting the whole list
        # is empty. The archive page keeps its own empty state.
        rows = ""
